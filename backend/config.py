...
# Database config (FIXED: Match database.py filename)
DB_URL = os.getenv("DB_URL", "sqlite:///./biometric_analytics.db")
...
# File upload config (UPDATED: Match actual folder structure)
UPLOAD_DIR = Path("uploads")
ID_DOCUMENTS_DIR = UPLOAD_DIR / "temp_documents"  # Changed from "id_documents"
LIVE_IMAGES_DIR = UPLOAD_DIR / "temp_images"      # Changed from "live_images"
...
# Allowed extensions (SIMPLIFIED: Removed PDF for Aadhaar focus)
ALLOWED_ID_EXTENSIONS = {".jpg", ".jpeg", ".png"}  # Removed .pdf
